...
This folder contains an example Terraform configuration that uses the [vpc module](../../v0.0.3/modules/vpc) to deploy a custom Virtual Private Cloud (VPC) in an Amazon Web Services (AWS) account.
